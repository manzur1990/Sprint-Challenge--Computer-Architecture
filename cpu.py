...
class CPU:
    ...
    def __init__(self):
        ...
        self.branch_instruction[HLT] = self.hlt
        self.branch_instruction[LDI] = self.ldi
        self.branch_instruction[PRN] = self.prn
        self.branch_instruction[PUSH] = self.push
        self.branch_instruction[POP] = self.pop
        self.branch_instruction[CALL] = self.call
        self.branch_instruction[RET] = self.ret
        self.branch_instruction[JMP] = self.jmp
        self.branch_instruction[JEQ] = self.jeq
        self.branch_instruction[JNE] = self.jne

        # ALU branch_instruction
        self.alu_branch_instruction = {}
        self.alu_branch_instruction[ADD] = self.add
        self.alu_branch_instruction[SUB] = self.sub
        self.alu_branch_instruction[MUL] = self.mul
        self.alu_branch_instruction[CMP] = self.cmp
    ...
    def run(self):
        ...
        while self.halted:
            ...
            if ((IR >> 5) & 0b001 == 1):
                ...
                self.branch_instruction[IR](op_a, op_b)
    ...
    def alu(self, op, reg_a, reg_b):
        ...
        self.alu_branch_instruction[op](reg_a, reg_b)
